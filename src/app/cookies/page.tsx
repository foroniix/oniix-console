...
const sections = [
  {
    ...
    body: "Ils maintiennent la session, la securite d'acces et le bon fonctionnement de la console. Sans eux, l'authentification, le changement d'espace et certaines operations critiques ne fonctionnent pas correctement.",
  },
  {
    title: "2. Mesure d'usage produit",
    body: "Oniix peut enregistrer des signaux d'usage limites pour ameliorer l'experience console, diagnostiquer les incidents et suivre la qualite des parcours live. Ces mesures restent liees au produit et non a une regie publicitaire tierce.",
  },
  {
    title: "3. Duree de conservation",
    body: "Les cookies de session sont conserves le temps necessaire a l'authentification et a la securite. Les preferences de consentement peuvent etre memorisees jusqu'a douze mois afin d'eviter une demande repetee a chaque visite.",
  },
  {
    title: "4. Gestion des preferences",
    body: "Tu peux choisir les cookies essentiels uniquement ou accepter les mesures d'usage. La banniere de consentement reste la reference visible cote interface, et les preferences peuvent etre reinitialisees depuis le navigateur.",
  },
];
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="mt-3 max-w-2xl text-sm leading-7 text-[#655d53]">
                  Oniix utilise des cookies de session indispensables et des mesures d&apos;usage produit limitees pour
                  operer une plateforme OTT securisee et exploitable.
                </p>
              </div>
            </div>
